...
Call counts are what you can reason about up front. For what a run actually
spent — tokens and dollars, broken down by step and by model — see
[what a run spent](/reference/scripting-contract#what-a-run-spent).
