...
<Steps>
  ...
  <Step title="Open it in the workbench">
    Before you commit the plan, open it in the [workbench](/using/plan-workbench) — a dual-pane TUI for reviewing, tweaking, and test-running plans:
    ...
    <WorkbenchShot
      ...
      caption="A loaded plan in the workbench: chat agent left, step tree and detail right."
    />
  </Step>
