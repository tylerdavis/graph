...
Run it with `GRAPH_STORAGE=memory` in the cron environment — ephemeral, no lock contention with anything else on the box ([scripting contract](/automation/scripting)).
