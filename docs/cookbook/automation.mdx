...
The default embedded database is single-process. Automation should use `GRAPH_STORAGE=memory`; on a shared box, give concurrent long-lived processes separate `data_dir`s.
