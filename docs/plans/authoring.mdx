...
<Frame caption="The authoring loop in one screen: the draft's step tree, its validation verdict, and the agent that edits it.">
  <img src="/images/workbench/workbench-overview.svg" alt="The authoring loop in one screen: the draft's step tree, its validation verdict, and the agent that edits it." />
</Frame>
