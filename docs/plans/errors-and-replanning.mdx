...
| Tool error | a step's tool failed | hard failure — *except* inside an [`agent` step](/plans/agent-step), where it returns into the loop | replan |
