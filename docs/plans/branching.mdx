...
<Frame caption="A decide fork after a run down its then branch: the inline step list nests under the blue then head; the single-call else was never rendered.">
  <img src="/images/workbench/branching-decide.svg" alt="A decide fork after a run down its then branch: the inline step list nests under the blue then head; the single-call else was never rendered." />
</Frame>
