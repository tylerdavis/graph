...
<Frame caption="A map paused mid-run by a loop-line breakpoint: the first iteration done, the second awaiting the debugger's decision on the one structural body row.">
  <img src="/images/workbench/iteration-map.svg" alt="A map paused mid-run by a loop-line breakpoint: the first iteration done, the second awaiting the debugger's decision on the one structural body row." />
</Frame>
