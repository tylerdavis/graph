...
Three plans that ship as working examples — each demonstrates a different finish mode and a different design lesson. For CI-shaped plans (merge gates, PR reviewers), see the [CI cookbook](/plans/ci-cookbook).
