...
| `model` | no | model for the `infer` verdict: any configured [role](/models/models-and-providers#roles), standard or custom, or `default`; ignored without `infer` |
...
| `model` | no | model for the loop: any configured [role](/models/models-and-providers#roles), standard or custom, or `default` |
