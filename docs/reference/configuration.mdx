...
capture_content = false          # prompts, completions, tool arguments, step results on spans
...
| `capture_content` | — | put prompts, completions, tool arguments, and step results on spans (off: token counts and cost only) |
