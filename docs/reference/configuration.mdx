...
`packs` enables [bundled tool packs](/tools/user-defined#bundled-packs) — tool definitions that ship inside the binary. A user tool with the same name shadows the pack version.
